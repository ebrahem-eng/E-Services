...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.rtl.min.css" integrity="sha384-gXt9imSW0VcJVHezoNQsP+TNrjYXoGcrqBZJpry9zJt8PCQjobwmhMGaDHTASo9N" crossorigin="anonymous">
  ...
  <main id="main" class="main" dir="rtl">
    ...
    <div class="pagetitle">
      <h1>  تحكيم واستشارة  </h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">الرئيسية</a></li>
          <li class="breadcrumb-item active"> تحكيم واستشارة</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title "> تحكيم واستشارة  </h5>
<p>  الحياة الجامعية ممتلئة بالمشاكل والصعوبات التي تواجهك وتعرقل طريق تقدمك بالإضافةإلى صعوبة في اتخاذ قرارات ربما تكون مصيرية في بعض الأحيان ,فنحن هنا جاهزون لسماعك ومساعدتك في جميع مشاكلك. </p>
              ...
              <form class="row g-3" action="{{route('store_Ask_Us')}}" method="POST" enctype="multipart/form-data">
                @csrf
                   <div class="mb-12">
                    <div class="form-group">
                 <label for="formFile" class="form-label">قم   بإخبارنا : </label>
