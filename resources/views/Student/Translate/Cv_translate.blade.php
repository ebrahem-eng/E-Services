    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">سيرة ذاتية </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title ">ترجمة سيرة ذاتية</h5>
              ...
              <form class="row g-3" action="{{route('store-cv-translate')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-4">
                  <label for="validationDefault01" class="form-label">اسم صاحب السيرة الذاتية</label>
                  <input type="text" class="form-control" id="validationDefault01" name="name" required>
                   ...
                   <div class="mb-12">
                     ...
                     <input class="form-control" type="file" id="formFile" name="file_translate_cv" required>
                   </div>
