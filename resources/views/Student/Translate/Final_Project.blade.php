    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">رفع نص للترجمة </li>
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title ">ترجمة مشاريع تخرج</h5>
              ...
              <form class="row g-3" action="{{route('store-project')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-4">
                  <label for="validationDefault01" class="form-label">اسم المشروع</label>
                  <input type="text" class="form-control" id="validationDefault01" name="name" required>
                </div>
                <div class="col-md-4">
                  <label for="validationDefault04" class="form-label">الترجمة من</label>
                  <select class="form-select" id="validationDefault04" name="Translate_from" required>
                ...
                <div class="col-md-4">
                  <label for="validationDefault04" class="form-label" >الترجمة إلى</label>
                  <select class="form-select" id="validationDefault04" name="Translate_to" required>
                    <option selected disabled value=""> اختر اللغة...</option>
                        <option>العربية</option>
                    <option>الإنكليزية</option>
                  </select>
                   ...
                   <div class="mb-12">
                     <label for="formFile" class="form-label">قم باختيار الملف المراد ترجمته</label>
