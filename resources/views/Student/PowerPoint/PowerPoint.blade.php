...
<html lang="en">
 ...
 <title> إنشاء عروض تقديمية - SPU Translate</title>
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.rtl.min.css" integrity="sha384-gXt9imSW0VcJVHezoNQsP+TNrjYXoGcrqBZJpry9zJt8PCQjobwmhMGaDHTASo9N" crossorigin="anonymous">
  ...
  <main id="main" class="main" dir="rtl">
    ...
    <div class="pagetitle">
      <h1> إنشاء عروض تقديمية  </h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">الرئيسية</a></li>
          <li class="breadcrumb-item active">  إنشاء عروض تقديمية  </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title "> إنشاء عروض تقديمية   </h5>
          <p>تعتبر العروض التقديمية أكثر فائدة بالتأكيد من حيث زيادة مشاركة الطلاب. تحتوي كل شريحة على مستوى من الإبداع يجذب ذهن الطلاب و تجعل العروض التقديمية الطلاب يتعلمون أي موضوع بشكل أفضل. كما أنه يساهم في خلق مناقشة حية في الفصل الدراسي.</p>
              ...
              <form class="row g-3 d-flex justify-content-center" action="{{route('store_PowerPoint')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-4">
                  <label for="validationDefault01" class="form-label"> قم بإدخال عنوان العرض التقديمي     </label>
                  ...
                  <div class="form-group">
                       <label for="exampleFormControlTextarea1" ><span>قم بإدخال العناوين الفرعية المراد التكلم عنها </span></label>
                       <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="secound_title"></textarea>
                  </div>
                  </div>
