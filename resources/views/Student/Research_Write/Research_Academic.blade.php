    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">  أكاديمية  </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title "> كتابة بحث أكاديمي </h5>
            <p>أهمية البحث الأكاديمي تنبع من إثبات الفرضيات والمعطيات، فالبحث الأكاديمي يحتوي على الكثير من الملاحظات والمعرفة والمعلومات لحل المشكلات بالإضافة إلى التفكير في حلول أخرى لها والتحسين من منتجات جديدة، وأيضاً يوفر البحث مساحة كبيرة للأشخاص والصناعات والبلدان للتأكد من المعلومات بواسطة تحويل النظريات المجردة إلى تعلّم عالي، ومن المهم أن يكون البحث في المستوى المحلي بما يلائم المنطقة ونهجها واحتياجاتها.</p>
              ...
              <form class="row g-3" action="{{route('store_Research_Academic')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-4">
                  <label for="validationDefault01" class="form-label"> قم بإدخال عنوان البحث     </label>
