    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">  قانونية  </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title "> كتابة بحث قانوني </h5>
           <p>البحث العملي في المجال القانوني هو بحث علمي محدد في المجال القانوني ، يهدف إلى دراسة المشكلات القانونية الفردية والجماعية، والعوامل التي تدخل بها ،والقوانين والتشريعات والدساتير التي تشترك في الحياة الإنسانية الفردية والجماعية ، و العمل على تطوير و تحسين تلك القوانين و الدساتير و التشريعات ، و إيجاد الحلول المناسبة للمشكلات القانونية ،وتطبيقها في الوقت الحاضر والمستقبل.</p>
              ...
              <form class="row g-3" action="{{route('store_Research_Legal')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-4">
