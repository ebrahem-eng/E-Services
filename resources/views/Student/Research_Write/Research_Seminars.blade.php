    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"> كتابة أبحاث  </li>
          <li class="breadcrumb-item active">  حلقة بحث  </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title "> كتابة حلقة بحث  </h5>
            <p>مفهوم حلقة البحث، الأمر الذي يهم كل طالب في الدراسات العليا، وخاصة إذا كان في إحدى الكليات النظرية مثل كلية التربية، أو الآداب، أو تلك الكليات التي تهتم بالعلوم الإنسانية والاجتماعية، فالبحث العلمي هو الوسيلة التي يمكن من خلالها الوصول إلى حل للمشكلات التي تؤرق الإنسان وتحيره، وكذا اكتشاف حقائق جديدة عن طريق البحث والتجريب، وهو الطريقة الوحيدة للمعرفة حول العالم، لأنه يعتمد على طرق علمية، والتي بدورها تعتمد على الأساليب المنظمة المتمثلة في الملاحظة وتسجيل المعلومات، والقياس والوصف، وتكوين الفرضيات والاستدلال.</p>
              ...
              <form class="row g-3" action="{{route('store_Research_Seminars')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-4">
                  <label for="validationDefault01" class="form-label"> قم بإدخال عنوان حلقة البحث     </label>
