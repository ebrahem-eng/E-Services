    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">  اقتصادية  </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title "> كتابة بحث اقتصادي </h5>
           <p>يعتبر البحث العلمي إحدى الركائز الأساسية للتنمية الشاملة؛ لما له من ارتباط وثيق بتنمية اقتصادات الدول المتقدمة من خلال رفع معدلات الإنتاج وتحسين نوعيته وفعاليته وإدخال الأساليب والتقنيات الحديثة في النشاطات الإنتاجية والإدارية في مختلف القطاعات، ما أدى إلى تطويرها وزيادة مساهمتها في الناتج المحلي القومي للدول الصناعية الكبرى . </p>
              ...
              <form class="row g-3" action="{{route('store_Research_Economic')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-4">
