    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">  علمي  </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title "> كتابة بحث علمي </h5>
           <p>يعتبر تطوير البحث العلمي أحد أهم غايات الدول والمجتمعات التي تطمح لتطوير أبنيتها المعرفية والعلمية،

وبالتالي تحقيق الازدهار والتفوق في جميع مناحي الحياة..

كما أن أهمية البحث العلمي تكمن في كونه أداة فريدة للبقاء على صلة مع عالمنا المعقد،

الذي لا يتوقف عن التطور، وبدونه، سنضطر إلى الاعتماد فقط على الحدس، وسلطة الآخرين، والحظ الأعمى.</p>
              ...
              <form class="row g-3" action="{{route('store_Research_Scientific')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-4">
