    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"> أبحاث</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title ">تدقيق أبحاث  </h5>
            ...
            @if(session('message'))
              ...
              <form class="row g-3" action="{{route('store_Editing_Check_Research')}}" method="POST" enctype="multipart/form-data">
                @csrf

                   <div class="mb-12">
                     <label for="formFile" class="form-label">قم باختيار الملف المراد <span class="fw-bold">تَدْقِيقَهُ</span></label>
                     <input class="form-control" type="file" id="formFile" name="file_check_research" required>
                   </div>
