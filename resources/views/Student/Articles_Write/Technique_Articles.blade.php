    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"> مقالات تقنية  </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title "> كتابة  مقال تقني </h5>
              ...
              <form class="row g-3" action="{{route('store_Technique_Articles')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-4">
