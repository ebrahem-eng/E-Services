...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.rtl.min.css" integrity="sha384-gXt9imSW0VcJVHezoNQsP+TNrjYXoGcrqBZJpry9zJt8PCQjobwmhMGaDHTASo9N" crossorigin="anonymous">
  ...
  <main id="main" class="main" dir="rtl">
    ...
    <div class="pagetitle">
      <h1>مقالات أدبية/إبداعية  </h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">الرئيسية</a></li>
          <li class="breadcrumb-item"> كتابة مقالات  </li>
          <li class="breadcrumb-item active">مقالات أدبية   </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title "> كتابة  مقال أدبي   </h5>
              ...
              <form class="row g-3" action="{{route('store_Literary_Articles')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-4">
