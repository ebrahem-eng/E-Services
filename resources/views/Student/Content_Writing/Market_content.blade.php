    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"> طلب كتابة محتوى   </li>
          <li class="breadcrumb-item active">محتوى تسويقي  </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title "> كتابة محتوى تسويقي </h5>
              <p>يعتبر كتابة المحتوى التسويقي من أفضل وسائل التسويق، بل إنها أثبتت فاعلية كبيرة في الوصول إلى أعلى أرباح في وقتنا الحالي، ومع ازْدياد أعداد الشركات الصاعدة، أصبح قليلًا ما تجد مجال لا يمكن التنافس فيه بشكل تجاري، وهذا يُصعب على شركتك أن تتواجد بصورة جيدة في الأسواق، وأن تُحافظ على العملاء القدامى بل وأن تجذب عملاء جدد من أجل زيادة الأرباح، لذلك سوف نتعرف على ماهية التسويق بالمحتوى، وطريقة كتابة محتوى تسويقي بشكل مميز يصل بنشاطك إلى النجاح.</p>
              ...
              <form class="row g-3" action="{{route('store_Market_content')}}" method="POST" enctype="multipart/form-data"> 
                @csrf
                <div class="col-md-4">
                  <label for="validationDefault01" class="form-label"> اسم المنتج المراد تسويقه </label>
                  <input type="text" class="form-control" id="validationDefault01" name="name" required>
                </div>
                  <div class="col-md-8">
                  <div class="form-group">
                       <label for="exampleFormControlTextarea1" ><span>مواصفات وميزات المنتج المراد تسويقه مع كافة التفاصيل والأسعار</span></label>
                       <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="about_content"></textarea>
                  </div>
                  </div>
