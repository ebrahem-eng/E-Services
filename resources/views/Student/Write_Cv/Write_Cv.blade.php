...
<html lang="en">
  <head>
    ...
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
     ...
     <title>   كتابة  سيرة ذاتية  - SPU Translate</title>
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.rtl.min.css" integrity="sha384-gXt9imSW0VcJVHezoNQsP+TNrjYXoGcrqBZJpry9zJt8PCQjobwmhMGaDHTASo9N" crossorigin="anonymous">
  ...
  <main id="main" class="main" dir="rtl">
    ...
    <div class="pagetitle">
      <h1> كتابة سيرة ذاتية  </h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">الرئيسية</a></li>
          <li class="breadcrumb-item active">   كتابة سيرة ذاتية   </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<section>
   ...
   <div class="col-lg-9 m-auto">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title "> كتابة سيرة ذاتية   </h5>
          <p>تعتبر السيرة الذاتية وسيلتك للتعريف عن نفسك بطريقة مهنية وتسويق مهاراتك وخبراتك بين أرباب العمل. هي جوازك الأول للوصول إلى مرحلة المقابلة الشخصية، فلن تتمكّن من دونها من الحصول على فرصتك سواء في العمل أو التدريب أو غير ذلك من الفرص.</p>
              <p>قم بادخال جميع المعلومات وتأكد من صحتها جيداً </p>
              ...
              <form class="row g-3 d-flex justify-content-center" action="{{route('store_Write_Cv')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-4">
                  <label for="validationDefault01" class="form-label"> قم بإدخال الاسم     </label>
                  <input type="text" class="form-control" id="validationDefault01" name="name" required>
                </div>
                <div class="col-md-4">
                  <label for="validationDefault04" class="form-label">اختر اللغة المرادة</label>
                  <select class="form-select" id="validationDefault04" name="language" required>
                    <option selected disabled value=""> اختر اللغة...</option>
                        <option>العربية</option>
                    <option>الإنكليزية</option>
                  </select>
                </div>
                  <div class="col-md-8">
                  <div class="form-group">
                       <label for="exampleFormControlTextarea1" ><span>المعلومات الشخصية</span></label>
                       <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="deatils"></textarea>
                  </div>
                  </div>
                                    <div class="col-md-8">
                  <div class="form-group">
                       <label for="exampleFormControlTextarea1" ><span>المؤهلات الأكاديمية</span></label>
                       <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="acadimic"></textarea>
                  </div>
                  </div>
                                    <div class="col-md-8">
                  <div class="form-group">
                       <label for="exampleFormControlTextarea1" ><span>الخبرة الوظيفية</span></label>
                       <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="jop"></textarea>
                  </div>
                  </div>
                                    <div class="col-md-8">
                  <div class="form-group">
                       <label for="exampleFormControlTextarea1" ><span>الدورات التدريبية والأنشطة</span></label>
                       <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="course"></textarea>
                  </div>
                  </div>
                                    <div class="col-md-8">
                  <div class="form-group">
                       <label for="exampleFormControlTextarea1" ><span>المهارات</span></label>
                       <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="skils"></textarea>
                  </div>
                  </div>
                                    <div class="col-md-8">
                  <div class="form-group">
                       <label for="exampleFormControlTextarea1" ><span>الهوايات</span></label>
                       <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="hobbies"></textarea>
                  </div>
                  </div>
                                    <div class="col-md-8">
                  <div class="form-group">
                       <label for="exampleFormControlTextarea1" ><span>التزكيات</span></label>
                       <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="zakst"></textarea>
                  </div>
                  </div>
                  
                  <div class="col-md-8">
                   <div class="mb-12">
                     <label for="formFile" class="form-label"> قم برفع الشهادات الحاصل عليها</label>
                     <input class="form-control" type="file" id="formFile" name="file_write_cv" required>
                   </div>
                  </div>
