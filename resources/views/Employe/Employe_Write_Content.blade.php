              ...
              <table class="table datatable  table-hover">
                <thead >
                  <tr>
                    ...
                    <th scope="col">اسم المنتج المراد تسويقه</th>
                    <th scope="col">مواصفات وميزات المنتج </th>
                    <th scope="col"> تاريخ رفع الطلب</th>
                    <th scope="col"> </th>
                  </tr>
                </thead>
                <tbody>
                  @foreach($market_content as $result)
                  <tr>
                    <th scope="row">{{$result->id}}</th>
                    <td>{{$result->user->name}}</td>
                    <td>{{$result->user->email}}</td>
                    <td>{{$result->name}}</td>
                    <td>{{$result->About_Of_Content}}</td>
