...
<html lang="en">
  <head>
    ...
    <title> إعطاء صلاحيات لموظفين - SPU Translate</title>
    ...
    <aside id="sidebar" class="sidebar" dir="rtl">
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          ...
          >
            <li>
              <a href="{{route('admin.give_employe')}}" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">إعطاء صلاحيات لموظف</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card-body">
                    ...
                    <td>{{$result->email}}</td>
                     <td>                 
                        <div class="form-check fs-6">
                          <input class="form-check-input position-static" type="checkbox" id="blankCheckbox" value="option1" aria-label=""> الترجمة
                        </div>
                        <div class="form-check fs-6">
                          <input class="form-check-input position-static" type="checkbox" id="blankCheckbox" value="option1" aria-label=""> كتابة المحتوى
                        </div>
                        <div class="form-check fs-6">
                          <input class="form-check-input position-static" type="checkbox" id="blankCheckbox" value="option1" aria-label=""> كتابة المقالات
                        </div>
                        <div class="form-check fs-6">
                          <input class="form-check-input position-static" type="checkbox" id="blankCheckbox" value="option1" aria-label=""> كتابة الابحاث
                        </div>
                        <div class="form-check fs-6">
                          <input class="form-check-input position-static" type="checkbox" id="blankCheckbox" value="option1" aria-label=""> التدقيق والتحرير
                        </div>
                        <div class="form-check fs-6">
                          <input class="form-check-input position-static" type="checkbox" id="blankCheckbox" value="option1" aria-label="">  كتابة السيرة الذاتية
                        </div>
                        <div class="form-check fs-6">
                          <input class="form-check-input position-static" type="checkbox" id="blankCheckbox" value="option1" aria-label="">  انشاء عروض تقديمية
                        </div>
                     </td>
              ...
              <!-- End Table with stripped rows -->
                ...
                <div class="col-12 d-flex justify-content-center p-4" >
                  <button class="btn btn-primary"style="width: 100px;" type="submit">تأكيد</button>
                </div>
