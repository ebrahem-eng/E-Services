      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          ...
          >
            ...
            <li>
              <a href="{{route('admin.addemploye')}}" class="active">
        ...
        <div class="col-lg-8 m-auto ">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" novalidate action="{{route('store_Add_Employe')}}" method="POST">
                @csrf
                ...
                <div class="col-md-6 position-relative">
                  <label for="validationTooltip03" class="form-label">كلمة السر</label>
                ...
                <div class="col-12 d-flex justify-content-center">
                  <button class="btn btn-primary ps-4 pe-4 " type="submit">إضافة</button>
                </div>
