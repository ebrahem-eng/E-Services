...
<html lang="en">
  <head>
    ...
    <title> أرشيف الموظفين - SPU Translate</title>
  ...
  <body>
    ...
    <aside id="sidebar" class="sidebar" dir="rtl">
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <!-- End Icons Nav -->
                 <li class="nav-item">
        <a class="nav-link " href="{{route('admin.archives_employe')}}">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">أرشيف الموظفين</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>
                  @foreach($employedelete as $result)
                  <tr class="text-secondary">
                    ...
                    <td> محذوف</td>
                    <td class="text-center"><a href="{{route('Restore_Employe_Archives',$result->id)}}"><i class="bi bi-arrow-return-left"></i></a></td>
                    <td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="{{route('Force_Employe_Archives',$result->id)}}" method="POST">
          @method('GET')
          @csrf
