...
<html lang="en">
  <head>
    ...
    <title>إضافة خدمة جديدة  - SPU Translate</title>
        ...
        <div class="col-lg-8 m-auto ">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" novalidate action="{{route('Update_Employe',$editemploye->id)}}" method="POST">
                @method('PUT')
                @csrf
                <div class="col-md-6 position-relative">
                  <label for="validationTooltip01" class="form-label">الاسم</label>
                  <input type="text" class="form-control" id="validationTooltip01" value="{{$editemploye->name}}" name="name" required>
                  ...
                  <label for="validationTooltipUsername" class="form-label">البريد الالكتروني</label>
                  <div class="input-group has-validation">
                    <input type="text" class="form-control" value="{{$editemploye->email}}" id="validationTooltipUsername" name="email" aria-describedby="validationTooltipUsernamePrepend" required>
                ...
                <div class="col-md-6 position-relative">
                  <label for="validationTooltip05" class="form-label">الرمز الوظيفي</label>
                  <input type="text" class="form-control" value="{{$editemploye->id}}" id="validationTooltip05"  name="id" required>
                  <div class="invalid-tooltip">
                    الحقل هذ مطلوب
                  </div>
                </div>
                ...
                <div class="col-12 d-flex justify-content-center ">
                  ...
                  <button class="btn btn-primary ps-4 pe-4 " type="submit">تعديل</button>
